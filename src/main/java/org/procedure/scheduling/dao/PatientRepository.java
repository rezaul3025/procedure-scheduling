...
/**
 * PatientRepository extends the Spring JpaRepository which takes the the domain class Doctor 
 * to manage as well as the id type of the domain class as type arguments.
 * PatientRepository get the most relevant CRUD methods for standard data access available
